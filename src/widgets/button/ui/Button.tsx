...
export default function PrimaryButton({text = "", size = "default", glow = true, hasIcon = false, icon, disabled}: TButtonProps) {
  return (
    <button disabled={disabled} className="w-fit rounded-[0.75rem] text-[1.5rem] p-[0.0625rem] bg-gradient-to-r from-[#FFF] from-0% to-[#FF3E00] to-100% disabled:pointer-events-none hover:scale-[1.06] drop-shadow-[0_0_40px_rgba(255,62,0,1)] transition-all duration-500 disabled:opacity-50 disabled:drop-shadow-none">
